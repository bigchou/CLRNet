...
class Detect(object):
    ...
    def show(self, data):
        ...
        print(len(lanes_xys))
        print(lanes_xys)
        lanes_xys = [item for item in lanes_xys if len(item) >= 1]
...
# (openmmlab) iis@iis-Z590-AORUS-ELITE-AX:~/Desktop/CLRNet$ python vis2.py configs/clrnet/clr_resnet34_culane_mod2.py --img images  --load_from culane_r34.pth --savedir ./output
